...
function calculate() {
    ...
    if (document.getElementById("adult-input").value == "" || document.getElementById("adult-input").value < 0) {
        var adult_num = 0
    } else {
        var adult_num = parseInt(document.getElementById("adult-input").value)
    }

    if (document.getElementById("child-input").value == "" || document.getElementById("child-input").value < 0) {
        var child_num = 0
    } else {
